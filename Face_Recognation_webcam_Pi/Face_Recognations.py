...
# It Only detect faces in every other frame of video.

# NOTE: This example requires OpenCV  to be installed on your PI.
...
# Create arrays of known faces with their names
...
while True:
    ...
    if process_this_frame:
        # This will find all the faces and face encodings in the current frame of video
        face_locations = face_recognition.face_locations(rgb_small_frame)
        face_encodings = face_recognition.face_encodings(rgb_small_frame, face_locations)

        face_names = []
        for face_encoding in face_encodings:
            # It's check a match for the known face(s)
